...
@section('page-detail-wrapper')
    <div class="account-head mb-0 d-flex justify-content-between align-items-center">
        <div>
            <span class="back-icon">
                <a href="{{ route('customer.account.index') }}">
                    <i class="ei-arrow_left"></i>
                </a>
            </span>
        ...
        <span class="account-action">
            <a href="{{ route('customer.profile.edit') }}" class="btn btn-outline">
