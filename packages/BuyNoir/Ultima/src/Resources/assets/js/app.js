...
Vue.component("accordian", require("./UI/components/accordian"));
Vue.component('top-nav-links', require('./UI/components/top-nav-links'));
Vue.component('brand-slider', require('./UI/components/brand-slider'));
Vue.component('vertical-slider', require('./UI/components/vertical-slider'));
Vue.component('category-links', require('./UI/components/category-links'));
