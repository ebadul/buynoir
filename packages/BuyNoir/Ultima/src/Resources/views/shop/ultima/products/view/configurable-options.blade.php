            ...
            <div class="attributes" v-if="childAttributes.length > 0">
                ...
                <div
                    ...
                    <span class="swatch-container" v-else>
                        <label class="swatch" v-for='(option, index) in attribute.options' v-if="option.id"
                            :data-id="option.id" :for="['attribute_' + attribute.id + '_option_' + option.id]"
                            :class="{'is-selected': selectedValues[attribute.id] && option.id == selectedValues[attribute.id]}">
                ...
                Vue.component('product-options', {
                    ...
                    methods: {
                        configure: function(attribute, value, event) {
                            this.selectedValues[attribute.id] = value;
