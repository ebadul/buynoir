...
<div class="form-container review-checkout-conainer">
    <accordian :title="'{{ __('shop::app.checkout.onepage.summary') }}'" :active="true">
        <div class="form-header mb-30" slot="header">
            ...
            <i class="ei-arrow_carrot-down"></i>
            <i class="ei-arrow_carrot-up"></i>
        </div>
        ...
        <div slot="body">
            ...
            <div class="cart-item-list">
                <h4 class="t-m">{{ __('velocity::app.checkout.items') }}</h4>
                    ...
                    <div class="row col-12 no-padding">
                        ...
                        <div class="col-10 no-padding fs16">
                            ...
                            {!! view_render_event('bagisto.shop.checkout.name.before', ['item' => $item]) !!}
                                ...
                                <div class="row fs20">
                                    <span class="col-12 product-name-title">{{ $item->product->name }}</span>
                                </div>
                            ...
                            <div class="row col-12">
                                ...
                                <i class="ei-icon_close text-down-4"></i>
