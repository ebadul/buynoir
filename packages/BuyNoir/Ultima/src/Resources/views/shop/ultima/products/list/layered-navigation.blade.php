    ...
    <script type="text/x-template" id="filter-attribute-item-template">
        <div :class="`cursor-pointer filter-attributes-item ${active ? 'active' : ''}`">
            <div class="filter-attributes-title" @click="active = !active">
                <i class="ei-arrow_carrot-right" v-if="!active"></i>
                <i class="ei-arrow_carrot-down" v-else></i>
                <h4 class="fw6 display-inbl col">@{{ attribute.name ? attribute.name : attribute.admin_name }}</h4>
            ...
            <div class="filter-attributes-content">
                ...
                <div class="price-range-wrapper" v-if="attribute.type == 'price'">
                    ...
                    <div class="filter-input col-12 p-0 d-flex justify-content-between align-items-center">
                        <input
                            type="text"
                            disabled
                            name="price_from"
                            ...
                            id="price_from" />
                        <label class="col text-center mb-0" for="to">to</label>
                        <input
                        type="text"
                        disabled
                        name="price_to"
