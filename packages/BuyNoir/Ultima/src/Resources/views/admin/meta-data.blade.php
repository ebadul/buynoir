...
@section('page_title')
    {{ __('ultima::app.admin.meta-data.title') }}
@stop
...
@section('content')
    <div class="content">
        <form
            ...
            @if ($metaData)
                action="{{ route('admin.ultima.store.meta-data', ['id' => $metaData->id]) }}"
            @else
                action="{{ route('admin.ultima.store.meta-data', ['id' => 'new']) }}"
            @endif
            >
            ...
            <div class="page-header">
                <div class="page-title">
                    <h1>{{ __('ultima::app.admin.meta-data.title') }}</h1>
                </div>
            ...
            <accordian :title="'{{ __('velocity::app.admin.meta-data.general') }}'" :active="true">
                <div slot="body">
                    ...
                    <div class="control-group">
                        <label>
                            {{ __('ultima::app.admin.meta-data.top-ribbon') }}
                        </label>
                        ...
                        <textarea
                            ...
                            id="top_ribbon"
                            name="top_ribbon">
                            {{ $metaData ? $metaData->top_ribbon : '' }}
                        </textarea>
                    </div>

                    <div class="control-group">
                        <label>
                            {{ __('ultima::app.admin.meta-data.bottom-ribbon') }}
                        </label>
                        ...
                        <textarea
                            ...
                            id="bottom_ribbon"
                            name="bottom_ribbon">
                            {{ $metaData ? $metaData->bottom_ribbon : '' }}
                        </textarea>
                    </div>
            ...
            <accordian :title="'{{ __('velocity::app.admin.meta-data.images') }}'" :active="false">
                <div slot="body">
                    <div class="control-group">
                        ...
                        @if(! isset($advertisement[4]) || ! count($advertisement[4]))
                            @php
                                $images[4][] = [
                                    'id' => 'image_1',
                                    'url' => asset('/themes/ultima/assets/images/ad_one.png'),
                                ];
                                $images[4][] = [
                                    'id' => 'image_2',
                                    'url' => asset('/themes/ultima/assets/images/ad_two.png'),
                                ];
                                $images[4][] = [
                                    'id' => 'image_3',
                                    'url' => asset('/themes/ultima/assets/images/ad_three.png'),
                                ];
                            @endphp
                    ...
                    <div class="control-group">
                        <label>
                            {{ __('ultima::app.admin.meta-data.advertisement-four-content') }}
                        </label>

                        <textarea
                            class="control"
                            id="advertisement_four_content"
                            name="advertisement_four_content">
                            {{ $metaData ? $metaData->advertisement_four_content : '' }}
                        </textarea>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        @if(! isset($advertisement[3]) || ! count($advertisement[3]))
                            @php
                                $images[3][] = [
                                    'id' => 'image_1',
                                    'url' => asset('/themes/ultima/assets/images/banner_two.jpeg'),
                                ];
                            @endphp
                    ...
                    <div class="control-group">
                        ...
                        @if(! isset($advertisement[2]) || ! count($advertisement[2]))
                            @php
                                $images[2][] = [
                                    'id' => 'image_1',
                                    'url' => asset('/themes/ultima/assets/images/banner_three.png'),
                                ];
                            @endphp
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            tinymce.init({
                ...
                image_advtab: true,
                valid_elements : '*[*]',
                selector: 'textarea#home_page_content,textarea#footer_left_content,textarea#subscription_bar_content,textarea#footer_middle_content,textarea#product-policy,textarea#advertisement_four_content,textarea#top_ribbon,textarea#bottom_ribbon',
