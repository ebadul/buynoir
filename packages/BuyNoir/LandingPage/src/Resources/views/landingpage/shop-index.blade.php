                ...
                <div class="row">
                  ...
                  <div class="col-lg-7 order-0 order-lg-1 mb-4 mb-lg-0">
                    <div class="screen__ipad">
                      <img class="ipad_img" src="{{ asset('buynoir/landingpage/assets/img/software/woman.jpeg')}}" alt="" data-aos="fade-up" data-aos-delay="0">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section class="software_web margin-t-12" id="Products">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-lg-7 order-0 order-lg-1 mb-4 mb-lg-0">
                    <div class="screen__ipad">
                      <img class="ipad_img" src="{{ asset('buynoir/landingpage/assets/img/shop.jpeg')}}" alt="" data-aos="fade-up" data-aos-delay="0">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section class="software_web margin-t-12" id="Products">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-lg-7 order-0 order-lg-1 mb-4 mb-lg-0">
                    <div class="screen__ipad">
                      <img class="ipad_img" src="{{ asset('buynoir/landingpage/assets/img/bakery.jpeg')}}" alt="" data-aos="fade-up" data-aos-delay="0">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="container">
                ...
                <div class="block__circle">
                  <div class="item_logo" data-aos="fade-up" data-aos-delay="0">
                    <img src="{{ asset('buynoir/landingpage/assets/img/software/logo/150.png')}}" alt="">
                  </div>
