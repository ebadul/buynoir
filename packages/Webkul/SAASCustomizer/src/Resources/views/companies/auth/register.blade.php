                ...
                <div class="form-container">
                    ...
                    <form class="registration" data-vv-scope="step-one" v-if="step_one" @submit.prevent="validateForm('step-one')">
                        ...
                        <div class="control-group">
                            ...
                            <button class="btn btn-lg btn-primary" :disabled="errors.has('step-one.password') || errors.has('step-one.password_confirmation') || errors.has('step-one.email')">{{ __('saas::app.tenant.registration.continue') }}</button>
                        </div>
                    </form>
                    ...
                    <form class="registration" @submit.prevent="validateForm('step-two')" data-vv-scope="step-two" v-show="step_two">
                        <div class="step-two">
                            ...
                            <div class="control-group">
                                <button class="btn btn-lg btn-primary" :disabled="errors.has('first_name') || errors.has('last_name') || errors.has('step-two.phone_no')">{{ __('saas::app.tenant.registration.continue') }}</button>
                            </div>
                        </div>
                    </form>
