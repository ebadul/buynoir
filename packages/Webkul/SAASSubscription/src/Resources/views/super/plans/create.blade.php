...
@section('content')
    <div class="content">
        <form method="POST" action="{{ route('super.subscription.plan.store') }}">
                    ...
                    <accordian :title="'{{ __('saassubscription::app.super-user.plans.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('name') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="name" name="name" data-vv-as="&quot;{{ __('saassubscription::app.super-user.plans.name') }}&quot;" value="{{ old('name') }}" />
                    ...
                    <accordian :title="'{{ __('saassubscription::app.super-user.plans.billing-amount') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('monthly_amount') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required|min_value:0'" class="control" id="monthly_amount" name="monthly_amount" data-vv-as="&quot;{{ __('saassubscription::app.super-user.plans.monthly-amount') }}&quot;" value="{{ old('monthly_amount') }}" />
                            ...
                            <div class="control-group" :class="[errors.has('yearly_amount') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required|min_value:0'" class="control" id="yearly_amount" name="yearly_amount" data-vv-as="&quot;{{ __('saassubscription::app.super-user.plans.yearly-amount') }}&quot;" value="{{ old('yearly_amount') }}" />
